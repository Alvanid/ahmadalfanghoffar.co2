    ...
    <section class="hero" id="main-content" role="main">
        <div class="hero-content">
            ...
            <div class="hero-buttons">
                ...
                <a href="CV-Ahmad-Alfan-Ghoffar.pdf" download class="btn-secondary" id="download-cv" aria-label="Unduh CV Ahmad Alfan Ghoffar">
    ...
    <section id="contact" class="container" aria-labelledby="contact-heading">
        <div class="card reveal">
            ...
            <div class="social-links">
                ...
                <a href="https://instagram.com/alvn.id_" target="_blank" rel="noopener noreferrer" class="social-link" aria-label="Kunjungi profil Instagram Ahmad Alfan Ghoffar">
                    <svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="https://tiktok.com/@alvn.id_" target="_blank" rel="noopener noreferrer" class="social-link" aria-label="Kunjungi profil TikTok Ahmad Alfan Ghoffar">
                    <svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
